...
const envSchema = z.object({
  ...
  GHL_CHECKIN_OBJECT_DATE_FIELD_KEY: z.string().optional().default("checkin_date"),
  GHL_CHECKIN_OBJECT_POINTS_FIELD_KEY: z.string().optional().default("points_total"),
  /** Primary/display name field on the Check-ins object ({{custom_objects.check_ins.check_in}}). */
  GHL_CHECKIN_OBJECT_NAME_FIELD_KEY: z.string().optional().default("check_in"),
  /**
   ...
   */
  GHL_CHECKIN_ASSOCIATION_ID: z.string().optional().default(""),
  /**
  ...
  CHECKIN_CALENDAR_TZ: z.string().default("America/Los_Angeles"),
});
